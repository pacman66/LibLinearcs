...
namespace liblinearcs {
    ...
    static class Helper {
        ...
        /// <summary>
        /// Perform a deep Copy of a single object.  (Not sure if it will work with an array)
        /// </summary>
        ...
        // static unsafe public void swapunsafe (double * array, int idxA, int idxB) {
        //     double temp = * (array + idxA);
        //     *(array + idxA) = * (array + idxB);
        //     *(array + idxB) = temp;
        // }

        // static unsafe public void swapunsafe (int * array, int idxA, int idxB) {
        //     int temp = * (array + idxA);
        //     *(array + idxA) = * (array + idxB);
        //     *(array + idxB) = temp;
        // }
