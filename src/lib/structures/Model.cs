...
namespace liblinear {
    public class Model {
        ...
        // Internal storage for the parameter
        private Parameter p_param;

        /// <value>Model parameters</value>
        public Parameter param {
            get { return p_param; }
            set { p_param = new Parameter(value); }
        }

        /* number of classes */
        // private int p_nr_class;
        /// <value>Number of classes in the model</value>
        public int nr_class { get; set; }
        ...
        /* Number of Features */
        // int p_nr_feature;
        /// <value>Number of features in the model</value>
        public int nr_feature { get; set; }
        ...
        /// <value>Bias to apply to the model</value>
        ...
        public double[] w {
            get { return p_w; }
            set {
                if (value == null) p_w = null;
                else {
                    Array.Resize(ref p_w, value.Length);
        ...
        public int[] label {
            ...
            set {
                if (value == null) p_label = null;
                    ...
                    Array.Resize(ref p_label, value.Length);
        ...
        void get_labels (ref int[] label) {
            if (label != null || label.Length >= this.label.Length) 
